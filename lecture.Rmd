...
If you have not yet watched [this Hans Rosling video](https://www.youtube.com/embed/Z8t4k0Q8e8Y) yet, please pause this video and do so.

- [Hans Rosling died in 2017 at the age of 68](https://en.wikipedia.org/wiki/Hans_Rosling) and thus did not live through the COVID-19 pandemic.
- Beyond his awesome accent, I think he does something really powerful in that video.
- He engages you in the data. He takes thousands of lines of data and uses it to tell a story.
- I hope we can use our time together to start down that path of you learning how to (carefully) use data to tell stories.
