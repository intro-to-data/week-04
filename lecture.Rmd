...
## YOUR CODE HERE
gapminder %>% 
  filter(nato, year == 1992) %>% 
  ggplot(aes(x = gdpPercap, y = lifeExp, size = pop, color = country)) + 
  geom_point() + 
  ylim(50, 100) + ## SEE WHAT A DIFFERENCE THIS ONE LINE MAKES!!!!
  theme_bw()
```
...
Can you create a column identifying Public Health students in our class?

```{r}
survey %>% select(DegreeProgram) %>% distinct()
